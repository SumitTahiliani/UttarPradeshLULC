...
def get_raster_path(year):
    ...
    base_url = "https://huggingface.co/datasets/sumittahiliani/UttarPradeshYearlyDynamicWorld/resolve/main/"
    ...
    if not os.path.exists(local_path):
        try:
            st.info(f"Downloading raster for {year}...")
            ...
            st.warning(f"Failed to download raster for {year}: {e}")
            return None
